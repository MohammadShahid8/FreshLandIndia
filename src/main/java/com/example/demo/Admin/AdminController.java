...
public class AdminController {
	...
	public String Adminlogincheck(@RequestParam("name") String name, @RequestParam("password") String password,
	...
	public String approveagro(@ModelAttribute("c2") agroEntity c2, @RequestParam("file") MultipartFile filename)
		...
		String path = ("D:\\SHAHID CODING\\SPRING BOOT\\FreshLandIndia\\src\\main\\resources\\static\\certificate");
	...
	public String addnewproduct(@ModelAttribute("c2") product c2, @RequestParam("pfile") MultipartFile filename1)
			throws IOException {
		String f1 = filename1.getOriginalFilename();

		String path1 = "D:\\SHAHID CODING\\SPRING BOOT\\FreshLandIndia\\src\\main\\resources\\static\\certificate";
	...
	public String updateproductagro(@ModelAttribute("c3") product c3, @RequestParam("pfile") MultipartFile filename1)
			throws IOException {
		String f1 = filename1.getOriginalFilename();

		String path1 = "D:\\SHAHID CODING\\SPRING BOOT\\FreshLandIndia\\src\\main\\resources\\static\\product";
	...
	public String reportgenerate(@RequestParam("startdate") Date startdate, @RequestParam("enddate") Date enddate,
			ModelMap mm) {
	...
	public String uploadblog(@ModelAttribute("c4") blog c4, @RequestParam("blogfile") MultipartFile filename)
			throws IOException {

		String f1 = filename.getOriginalFilename();

		String path1 = "D:\\SHAHID CODING\\SPRING BOOT\\FreshLandIndia\\src\\main\\resources\\static\\blogimg";
	...
	public String reportgenerateStudent(@RequestParam("startdate") Date startdate,
			@RequestParam("enddate") Date enddate, ModelMap mm) {
	...
	public String reportgeneratefarmer(@RequestParam("startdate") Date startdate, @RequestParam("enddate") Date enddate,
			ModelMap mm) {
	...
	public String soilreportger(@RequestParam("startdate") Date startdate, @RequestParam("enddate") Date enddate,
			ModelMap mm) {
