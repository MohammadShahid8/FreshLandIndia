	...
	<header>
		...
		<div class="searchbar" style="margin-left: 100px;">
			<input type="text" id="searchInput"
				...
				oninput="searchTable()" style="width: 500px;">
		...
		<div class="main">
			...
			<div class="report-container">
				<div class="report-header">
					<h1 class="recent-Articles" style="color: #f77f00;">
						<i class="fa-solid fa-list-ol"></i>&nbsp;&nbsp;Listed Product List
					</h1>
						...
						<tbody>
							<c:forEach items="${kk}" var="e">
								<tr>
									<td>${e.pname}</td>
									<td>${e.ptype}</td>
									<td><img src="product/${e.pfilen}" alt="Certificate Image"
										style="width: 130px; height: 100px;"> <a
										href="product/${e.pfilen}" download="Product.jpg">
									...
									<td>
										<form action="searchproductforedit" method="post">
											...
											<button type="submit"
												style="background-color: #29bf12; width: 100px; font-size: 15px; margin-left: 10px;"
												class="demo">
												Edit&nbsp;&nbsp;&nbsp;<i class="fa-regular fa-pen-to-square"></i>
											</button>
										</form> <br> <a href="deleteproduct/${e.id}"><button
												type="button" style="background-color: red; width: 100px;"
												class="demo">
