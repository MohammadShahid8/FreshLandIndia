...
<body>
	...
	<div class="main-container">
		...
		<div class="main">
			...
			<h3>
				Currently <span style="color: green;">Active</span> Blog On Website<i
			...
			<div class="content-container">
				<c:forEach items="${kk}" var="e">
					<div class="content-div"
						style="background: url(blogimg/${e.blogimg}) top left no-repeat;">
						<h2 style="color: #fff;">${e.title}</h2>
						<p style="color: #fff;">${e.dateout}</p>
						<a href="removeblog/${e.id}" style="color: red;">Remove&nbsp;<i
			...
			<div class="report-container" style="width: 900px;">
				<div class="report-header">
					<h1 class="recent-Articles" style="color: #ef2d56;">
						Blog Upload Form&nbsp;<i class="fa-solid fa-blog"></i>
					</h1>
				</div>
				...
				<form action="uploadblog" method="post"
					...
					<label for="title">Title:</label> <input type="text" name="title"
						required><br> <label for="content">Paragraph
						One:</label>
					<textarea name="cone" rows="4" required></textarea>
					<br> <label for="content">Paragraph Two:</label>
					<textarea name="ctwo" rows="4" required></textarea>
					<br> <label for="content">Paragraph Three:</label>
					<textarea name="cthree" rows="4" required></textarea>
					<br> <input type="date" id="myDate" name="dateout" value="" />

					<label for="image">Image:</label> <input type="file"
						name="blogfile"><br> <input type="submit"
						value="Upload Blog">
				</form>
