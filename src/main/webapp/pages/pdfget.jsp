			...
			<c:forEach items="${k}" var="e">
				...
				<div class="headerSection">
					...
					<div>
						<h3>Receipt to</h3>
						<p>
							<b> ${e.sname}</b> <br /> ${e.slocation} <br /> ${e.smobile} <br />
							<a href=" ${e.semail}"> ${e.semail} </a> <br />
					...
					<div class="hero">
						<h3>Due Date</h3>
						<p>
							<b>Submit Soil Sample Within The 1 Week With Receipt <br>
								to your Nearby AgroAgency <br> Register By FreshLandIndia.
							</b>
						</p>
						<h3>Amount</h3>
						<p>
		...
		<div class="sample">
			<main>
				<table>
					...
					<tbody>
						<tr>
							<td><b>${e.stype}</b> <br /> ${e.scomments}</td>
							<td>${e.sdepth}</td>
							<td>${e.sorganic}</td>
							<td>${e.stexture}</td>
							<td>${e.scrop}</td>
...
-->
	...
	<a href="home"
		style="padding: 15px; margin: 20px; background-color: green; border-radius: 34px; margin-top: 80px; color: #fff;">Home</a>
