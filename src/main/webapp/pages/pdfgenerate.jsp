...
<title>FreshLandIndia PDF</title>
...
*/
header .invoiceDetails, header .invoiceDetails h2 {
	text-align: right;
	font-size: 1em;
	text-transform: none;
}
...
*/
main table thead th:nth-of-type(2), main table thead th:nth-of-type(3),
...
*/
main table thead th:last-of-type, main table tbody td:last-of-type {
	text-align: center;
}
...
<body>
	...
	<div id="printSection">
		<header>
			...
			<div class="headerSection">
				...
				<div>
					<h3>Receipt to</h3>
					<p>
						<b> <%out.println(h1.getAttribute("sname"));%>
						</b> <br />
						<%out.println(h1.getAttribute("slocation"));%>
						<br />
						<%out.println(h1.getAttribute("smobile"));%>
						<br /> <a href="<%out.println(h1.getAttribute("semail"));%>">
				...
				<div class="hero">
					...
					<h4 class="verification-info">Verification Process:</h4>
					<ul class="list-unstyled">
						<li>Your details are being reviewed.</li>
						<li>It will take approximately 24 hours to complete the
		...
		<footer>
			<a href="https://companywebsite.com"> shahidms1870@gmail.Com </a> <a
				href="mailto:company@website.com"> FreshLandIndia.Com </a> <span>
				9934044770 </span>
		...
		<div class="sample">
			<main>
				<table>
					...
					<tbody>
						<tr>
							<td><b> <%out.println(h1.getAttribute("stype"));%>
							</b> <br /> <%out.println(h1.getAttribute("scomments"));%></td>
							<td>
			...
			<aside>
				...
				<div>
					<div>
						<b>All Rights Reserved By FreshLandIndia ©</b>
						<p></p>
					</div>
					<div>
...
-->
	...
	<a href="javascript:void(0)" class="btn-download"
		style="padding: 15px; margin: 20px; background-color: #ef233c; border-radius: 34px; margin-top: 80px; color: #fff;"">Download
		PDF <i class="fa-solid fa-file-pdf"></i>
	</a>

	<a href="home"
		style="padding: 15px; margin: 20px; background-color: green; border-radius: 34px; margin-top: 80px; color: #fff;">Home
	...
	<script>
		const options = {
			margin : 0.001,
			filename : 'SoilReceiptFreshLandIndia.pdf',
			image : {
				type : 'jpeg',
				quality : 1000
			},
