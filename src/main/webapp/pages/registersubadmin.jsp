		...
		<div class="main">
			...
			<ul class="subadmin-list">
				...
				<c:forEach items="${kk}" var="e">
					<li class="subadmin-item"><span>${e.name}</span> <span>${e.email}</span>
						<spam>${e.password}</spam> <a href="removesubadmin/${e.id}">
							<button class="remove-access-btn">
								Remove Access <i class="fa-regular fa-circle-xmark"></i>
							</button>
					</a></li>
				</c:forEach>
			</ul>
			...
			<div class="report-container" style="width: 500px;">
				<div class="report-header">
					<h4 class="recent-Articles">
						</i>Sub-Admin Registration<i class="fa-regular fa-address-card"></i>
					</h4>
				</div>
