...
<body>
	...
	<header>
		...
		<div class="searchbar">
			<input type="text" placeholder="Search by Location or Training Type"
				id="searchInput" oninput="searchTable()" style="width: 340px;">
			<div class="searchbtn">
				<i class="fa-solid fa-magnifying-glass"></i>
			</div>
		</div>
		<label style="margin-left: 20px; font-size: 15px"><i
			class="fa-regular fa-calendar"></i>&nbsp;Filter Daily,Weekly,Monthly</label>
		<form action="reportgetfarmer" method="get">
			...
			<button type="submit" class="demo">
				Generate Report<i class="fa-solid fa-wheat-awn-circle-exclamation"></i>
			</button>
		</form>
		...
		<div class="main">
			...
			<div class="report-container">
				<div class="report-header">
					<h1 class="recent-Articles" style="color: #16697a;">
						Farmer Training Request &nbsp; <i class="fa-solid fa-tractor"></i>
					</h1>
					<button onClick="tableToExcel()" class="download-button">
						Download Report &nbsp;<i class="fa-solid fa-file-excel"></i>
					</button>
				</div>
