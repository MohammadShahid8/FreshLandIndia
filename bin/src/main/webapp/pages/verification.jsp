	...
	<nav
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			<div class="navbar-nav mx-auto py-0">
				...
				<a href="Agrohome"><img src="img/logo.png" alt=""
					style="margin: 0px; width: 180px; margin: 10px; margin-right: 850px; border-radius: 15px;"></a>
				<a href="agro" class="nav-item nav-link active">Home</a> <a
			...
			<div class="col-md-8">
				<div class="card verification-card">
					<div class="card-body text-center">
						<h1 class="card-title"
							style="background-color: #219ebc; color: #fff; border-radius: 32px;">
							Welcome
							<%out.println(h1.getAttribute("aname"));%>
						</h1>
						<h2 class="card-title">Verification Pending</h2>
						<p class="card-text">Thank you for registering with us. Your
							account is currently under verification.</p>
						...
						<p class="card-text">
							Once verification is done, you can <a href="loginagro">log in</a>.
						</p>
					</div>
				</div>
				...
				<div class="card verification-card">
					<div class="card-body text-center">
						...
						<p class="card-text">
							...
							team at<br> shahidms1870@gmail.com
						</p>
					</div>
				</div>
			</div>
						...
						<div class="col-lg-4 col-md-12 pt-5 mb-5">
							...
							<div class="d-flex mt-4">
								<a class="btn btn-secondary btn-square rounded-circle me-2"
									href="https://twitter.com/GauravPatilGR"><i
									class="fab fa-twitter"></i></a> <a
									class="btn btn-secondary btn-square rounded-circle me-2"
									href="https://www.facebook.com/GauravpatilGR/"><i
									class="fab fa-facebook-f"></i></a> <a
									class="btn btn-secondary btn-square rounded-circle me-2"
									href="https://www.linkedin.com/in/gaurav-patil-038860269/"><i
									class="fab fa-linkedin-in"></i></a> <a
									class="btn btn-secondary btn-square rounded-circle"
									href="https://www.instagram.com/gauravpatil_13/"><i
