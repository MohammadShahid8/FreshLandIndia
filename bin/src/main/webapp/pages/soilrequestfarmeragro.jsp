...
<body>
	...
	<div class="content">
		<h3>
			Soil Analysis Request By Farmers<i class="fa-solid fa-chart-pie"></i>
		</h3>
		<div>
			<form id="searchForm" action="#" method="get">

				<input type="text" name="district" id="searchInput"
					oninput="searchTable()" placeholder="Search By Email or Location "
		...
		function searchTable() {
			...
			for (i = 0; i < tr.length; i++) {
				...
				if (tdName || tdCategory || tdOurPrice) {
					...
					txtValueCategory = tdCategory.textContent
							|| tdCategory.innerText;
					txtValueOurPrice = tdOurPrice.textContent
							|| tdOurPrice.innerText;

					if (txtValueName.toUpperCase().indexOf(filter) > -1
							|| txtValueCategory.toUpperCase().indexOf(filter) > -1
							|| txtValueOurPrice.toUpperCase().indexOf(filter) > -1) {
						tr[i].style.display = "";
					} else {
