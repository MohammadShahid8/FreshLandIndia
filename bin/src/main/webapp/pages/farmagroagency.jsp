		...
		<div class="container py-5">
			<div class="row justify-content-start">
				<div class="col-lg-8 text-center text-lg-start">
					<h1 class="display-1 text-white mb-md-4" style="font-size: 30px;">FreshLandIndia
						Register AgroAgencies</h1>
					<div class="container">
							...
							<div class="col-">
								...
								<div class="form">
									<i class="fa fa-search"></i> <input type="text"
										class="form-control form-input" id="searchInput"
										placeholder="Search by City or Town" onkeyup="searchTable()"
