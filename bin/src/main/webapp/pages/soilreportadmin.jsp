...
<body>
	...
	<header>
		...
		<div class="searchbar">
			<input type="text" placeholder="Search by Email or Location"
		...
		<div class="main">
			...
			<div class="report-container" style="width: 2500px;">
				<div class="report-header">
					<h1 class="recent-Articles" style="color: #6f4518;">
						Soil Analysis Request reports &nbsp; <i
							class="fa-solid fa-chart-pie"></i>
					</h1>
					<button onClick="tableToExcel()" class="download-button"
						style="background-color: #6f4518;">
