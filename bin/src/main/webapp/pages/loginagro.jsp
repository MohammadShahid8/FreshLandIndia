		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			<div class="navbar-nav mx-auto py-0">
				...
				<a href="agro" class="nav-item nav-link ">Home</a> <a
					...
					href="loginagro" class="nav-item nav-link active"><i
			...
			<div class="agileits-top">
				<form action="agrologin" method="post">
					...
					<input class="text email" type="email" name="email"
						placeholder="Enter register email" required=""> <input
						class="text" type="password" name="password"
						placeholder="Enter Password" required=""> <input
						type="submit" value="Login">
				</form>
				<a href="registeragro"><p
						style="color: #2dc653; font-family: sans-serif;">Don't have an
