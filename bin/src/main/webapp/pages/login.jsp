...
<head>
<meta charset="utf-8">
<title>FreshLandIndia Login</title>
...
.loginimgbackground {
	background-image:
		url(https://images.pexels.com/photos/15398173/pexels-photo-15398173/free-photo-of-a-trail-between-banana-trees.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1);
	margin-bottom: -90px;
}
</style>
</head>
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			<div class="navbar-nav mx-auto py-0">
				...
				<a href="register" class="nav-item nav-link "><i
					...
					class="fa-solid fa-seedling"></i>&nbsp;Login</a>
...
<body>
	<form id="loginForm" onsubmit="return validateForm()"
		action="loginfarm" method="post">
		<div class="row g-3">
			<div class="col-12">
				<input type="email" id="email" name="email"
					class="form-control bg-light border-0 px-4"
					placeholder="Enter Your Register Email" style="height: 55px;"
			...
			<div class="col-12">
				<a href="register"><button class="btn btn-secondary w-100 py-3"
						type="button">Register Here</button></a>
			</div>
	...
	<script>
		function validateForm() {
			...
			return true;
				...
				<div class="col-lg-5">
					<div class="h-100 p-5" style="background-color: #a06650;">
						...
						<div class="d-flex mb-4">
							...
							<div class="ps-3">
								...
								<span class="text-white">Bhopal,Madhya Pradesh</span>
							</div>
						</div>
						<div class="d-flex mb-4">
							<div
							...
							<div class="ps-3">
								...
								<span class="text-white">shahidms1870@gmail.com</span>
							</div>
						</div>
						<div class="d-flex">
							<div
							...
							<div class="ps-3">
								...
								<span class="text-white">+91 9934044770</span>
							</div>
						</div>
					</div>
				</div>
