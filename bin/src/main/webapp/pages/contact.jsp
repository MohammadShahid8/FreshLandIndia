...
<title>FreshLandIndia Contact us</title>
							...
							<div class="row g-3">
								<div class="col-6">
									<input type="text" name="name"
										...
										value="<%out.println(s3.getAttribute("name"));%>"
										style="height: 55px;" readonly>
								</div>
								<div class="col-6">
									<input type="email" name="email"
										class="form-control bg-light border-0 px-4"
										value="<%out.println(s3.getAttribute("email"));%>"
										style="height: 55px;" readonly>
								</div>
								<div class="col-12">
								...
								<div class="col-12">
									<textarea class="form-control bg-light border-0 px-4 py-3"
										name="message" rows="2" placeholder="Message"></textarea>
								</div>
								<div class="col-12">
									<button class="btn btn-secondary w-100 py-3" type="submit">Send
										Message</button>
								</div>
							</div>
						</form>
