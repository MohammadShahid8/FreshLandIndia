...
<body>
	...
	<nav
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			<div class="navbar-nav mx-auto py-0">
				...
				<a href="agro"><img src="img/logo.png" alt=""
					style="margin: 0px; width: 180px; margin: 10px; margin-right: 850px; border-radius: 15px;"></a>
				<a href="/" class="nav-item nav-link active">Home</a> <a
					href="registeragro" class="nav-item nav-link">Register</a> <a
					href="loginagro" class="nav-item nav-link">Login</a>
	...
	<div class="marquee-container">
		<marquee class="marquee"> FreshLandIndia AgroAgency
			Registration Portal - Register your AgroAgency With Us,Submit Your
			Details Now , 100% Online Process. | For Any Query Contact our
			HelplineNumber. </marquee>
	</div>
		...
		<div class="container-fluid p-0" style="background-color: black">
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img
						src="https://images.pexels.com/photos/12626272/pexels-photo-12626272.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
						class="w-100" alt="" style="opacity: 0.85;">
					...
					<div
						...
						<div class="text-start p-5" style="max-width: 900px;">
							...
							<p class="text-white" style="font-size: 30px;">FreshLandIndia
								is a web-based open discussion portal.</p>

							<a href="registeragro" class="btn btn-secondary py-md-3 px-md-5">Join
								As AgroAgency</a>
						</div>
					</div>
				</div>
				<div class="carousel-item">
					...
					<div
						...
						<div class="text-start p-5" style="max-width: 900px;">
							...
							<p class="text-white" style="font-size: 25px;">Providing
								information and solutions about crops, fertilizers, vegetables,
								Seeds, Fruits.</p>
				...
				<div class="carousel-item">
					...
					<div
						...
						<div class="text-start p-5" style="max-width: 900px;">
							...
							<p class="text-white" style="font-size: 25px;">Climate to
								Small farmers and agricultural students.</p>
					...
					<div class="col-lg-4">
						<div class="blog-item position-relative overflow-hidden">
							<img class="img-fluid" src="blogimg/${e.blogimg}" alt=""
								...
								class="text-white fw-bold">${e.dateout}</span>
							</a>
						</div>
					</div>
				</c:forEach>
						...
						<div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
							...
							<div class="d-flex flex-column justify-content-start">
								<a class="text-white mb-2" href="home"><i
									...
									class="text-white mb-2" href="blogfarm"><i
