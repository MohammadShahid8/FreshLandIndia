...
<body>
	...
	<nav
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			<div class="navbar-nav mx-auto py-0">
				...
				<a href="agro" class="nav-item nav-link ">Home</a> <a
					href="registeragro" class="nav-item nav-link active">Register</a> <a
					href="loginagro" class="nav-item nav-link"><i
	...
	<div class="main-w3layouts wrapper">
		<h1 style="color: #2dc653; font-family: sans-serif;">Agroagency
			Registration</h1>
		<p class="txt-center" style="color: #2dc653; font-family: sans-serif;">Register
			your Agroagency by filling in the Agroagency registration form below.</p>

		<div class="main-agileinfo">
			<div class="agileits-top">
				<form action="agro" method="post" enctype="multipart/form-data">
					<input class="text" type="text" name="name"
						placeholder="Agroagency Name" required=""> <input
						...
						class="text" type="hidden" name="status" value="pending"
						required=""> <input class="text w3lpass" type="text"
						name="district" placeholder="District" required=""> <input
						class="text w3lpass" type="text" name="town" placeholder="Town"
						required=""> <label for="file"
						style="color: red; font-size: 13px;">*Upload your Aadhaar
						Card</label> <input class="text w3lpass" type="file" name="file"
						placeholder="Town" required="" accept="image/*">
					<div class="wthree-text">


						<textarea id="address" class="text w3lpass " name="address"
							rows="6" required placeholder="Enter Your AgroShop  Full Address"
				...
				<a href="loginagro"><p
						style="color: #2dc653; font-family: sans-serif;">Alredy have
						an Account? Login Now!</p></a>
