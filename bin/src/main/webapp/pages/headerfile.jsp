			...
			<div class="navbar-nav mx-auto py-0">
				...
				<form action="searchname" method="post">
					...
					<button type="submit" class="custombutton"
						style="margin-right: 700px; margin-top: 10px; border: none; background-color: #f93; color: white;">
						<i></i>&nbsp; &nbsp;<%out.println(s1.getAttribute("name"));%>
					</button>
				</form>
				<a href="/" class="nav-item nav-link "><i
					class="fa-solid fa-house"></i>&nbsp;Home</a> <a href="aboutl"
					class="nav-item nav-link"><i class="fa-solid fa-globe"></i>&nbsp;About</a>
				<a href="service" class="nav-item nav-link"><i
					class="fa-solid fa-building"></i>&nbsp;Services</a> <a
					href="farmproduct" class="nav-item nav-link"><i
					class="fa-solid fa-cart-shopping"></i>&nbsp;Product</a> <a
					href="contact" class="nav-item nav-link"><i
					class="fa-solid fa-envelope"></i>&nbsp;Contact</a> <a href="/"
					class="nav-item nav-link"><i class="fa-solid fa-power-off"></i>&nbsp;Logout</a>
