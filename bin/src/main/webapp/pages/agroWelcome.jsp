		...
		<div class="container-fluid p-0" style="background-color: black">
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img
						src="https://images.pexels.com/photos/7543111/pexels-photo-7543111.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
					...
					<div
						...
						<div class="text-start p-5" style="max-width: 900px;">
							...
							<a href="Dashagro" class="btn btn-secondary py-md-3 px-md-5"><i
								class="fa-solid fa-user-tie"></i>Dashboard</a>
						</div>
					</div>
				</div>
				<div class="carousel-item">
					<img
						src="https://images.pexels.com/photos/3158017/pexels-photo-3158017.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
						class="w-100" alt="" style="opacity: 0.85;">
			...
			<div class="row gx-0">
				<div class="col-md-6">
					<div
						...
						<h3 class="text-white mb-3">
							View Farmer<i class="fa-solid fa-wheat-awn"></i>Training Request
						</h3>
						<a href="farmdisplay" class="btn btn-info py-md-3 px-md-5"><i
				...
				<div class="col-md-6">
					<div
						...
						style="height: 300px;">
						<h3 class="text-white mb-3">
							View Agro<i class="fa-solid fa-graduation-cap"></i>Student
							Training Request
						</h3>
						<a href="studisplay" class="btn btn-info py-md-3 px-md-5"><i
							class="fa-regular fa-eye"></i>View</a>
